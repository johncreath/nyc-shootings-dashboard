...
st.markdown(
    ...
    f"fairer comparisons across places and time periods.\n\n"

    f"This dashboard can help answer questions such as:\n\n"
    f"- Which boroughs experience the highest levels of gun violence?\n\n"
    f"- Do shooting patterns remain consistent across different times of day?\n\n"
    f"- When normalized, do patterns emerge that differ from what raw incident counts suggest?\n\n"
    f"- How do temporal patterns vary across boroughs?\n\n"
    "---\n\n"

    f"Click on the segmentation visuals to cross-filter the dashboard for deeper analysis."
)
...
st.markdown(
    ...
    f"##### Do Shootings Differ Between Weekdays and Weekends?\n\n"
